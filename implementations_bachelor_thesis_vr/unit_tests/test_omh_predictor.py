...
class TestStringMethods(unittest.TestCase):
    ...
    def test_calculate_new_alpha_j_no_clipping(self):
        ...
        outcome_alpha_1, _ = predictor._calculate_new_alpha_j(0, 1)
    ...
    def test_calculate_new_alpha_values_test1(self):
        ...
        outcome_alpha_values, _ = predictor._calculate_new_alpha_values(0, 1)
